...
var swiper = new Swiper(".fourmindSwiper", {
    ...
    on: {
        init: (swiper) => {
            ...
            btnRegister.forEach((e) => {
                e.addEventListener("click", () => {
                    ...
                    let courseDefaultPrice = e.getAttribute("data-courseDefaultPrice");
                    setCourseID(courseID);
                    setCourseTitle(courseTitle);
                    // setCourseDate(courseTitle, courseDate);
                    setCourseQuiz(courseQuiz);
                    setCoursePrice(courseMinPrice, courseMaxPrice, courseDefaultPrice);
                    pauseAllVideo();
                    swiper.slideNext();
                });
            });
        ...
        slideChangeTransitionEnd: (swiper) => {
            ...
            // Callback Replace English To Persian Digits
...
let setCoursePrice = (courseMinPrice, courseMaxPrice, courseDefaultPrice) => {
    ...
    setCoursePrice.setAttribute("value", courseDefaultPrice);
...
// Replace English To Persian Digits
let convertNumberToPersion = () => {
...
let convertEnNumberToPersian = (number) => {
...
let convertInput = () => {
    ...
    let allInput = document.querySelectorAll("#fourmind input");
    let allTextarea = document.querySelectorAll("#fourmind textarea");

    allInput.forEach((e) => {
        e.addEventListener("change", () => {
            convertEnNumberToPersian(e.value);
        });
    });
